      ...
      <div class="lcnl-card border-0 p-4 h-100 shadow-soft">
        ...
        <form action="<?= base_url('contact/send') ?>" method="post" class="needs-validation" novalidate>
          ...
          <div class="mb-4">
            ...
            <textarea id="message" name="message" rows="6" class="form-control" placeholder="Write your message here..."
      ...
      <div class="d-flex flex-column gap-4">
        ...
        <div class="lcnl-card shadow-soft">
          ...
          <div class="d-flex align-items-center gap-4 fs-4 socials">
            ...
            <a href="https://www.instagram.com/lcnlmahajan/" class="text-reset" target="_blank"
              aria-label="Instagram"><i class="bi bi-instagram"></i></a>
            <a href="https://vimeo.com/lcnl" class="text-reset" target="_blank" aria-label="Vimeo"><i
                class="bi bi-vimeo"></i></a>
          </div>
        </div>
