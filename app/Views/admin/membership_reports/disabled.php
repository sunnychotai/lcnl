...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h5 mb-0">
            <i class="bi bi-calendar-x me-2 text-brand"></i> Disabled Members
        </h1>
            ...
            <table id="reportTable" class="table table-striped table-hover align-middle w-100">
                <thead class="table-light">
                    <tr>
                        ...
                        <th data-data="m.status">m.disabled_reason</th>
                        <th data-data="m.status">m.disabled_notes</th>
...
<script>
    ...
    function exportHref() {
        ...
        return "<?= base_url('admin/membership/reports/disabled/export') ?>?" + qs;
    }
    ...
    $(function () {
        table = $('#reportTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url('admin/membership/reports/disabled/data') ?>",
                type: "POST",
                data: function (d) {
            ...
            columns: [
                ...
                { data: "disabled_reason", name: "m.disabled_reason" },
                { data: "disabled_notes", name: "m.disabled_notes" },
