...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h5 mb-0">
            <i class="bi bi-shield-x me-2 text-brand"></i> Not Verified
        </h1>
...
<script>
    ...
    function exportHref() {
        ...
        return "<?= base_url('admin/membership/reports/not-verified/export') ?>?" + qs;
    }
    ...
    $(function () {
        table = $('#reportTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url('admin/membership/reports/not-verified/data') ?>",
                type: "POST",
                data: function (d) {
