...
<section class="hero-lcnl-watermark hero-overlay-midnight-teal d-flex align-items-center justify-content-center">
  <div class="container position-relative text-center text-white py-4">
    <h1 class="fw-bold display-6 mb-1"><i class="bi bi-shield-lock-fill me-2"></i>Admin Login</h1>
        ...
        <div class="card-body p-4">
          <form action="<?= base_url('auth/attemptLogin') ?>" method="post" novalidate>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <!-- If you have a route for forgot password, update this href -->
              <a class="small text-decoration-none" href="<?= base_url('auth/forgot') ?>">Forgot password?</a>
            </div>
...
<!-- Page-specific tweaks to match LCNL style -->
<style>
  .auth-card {
