        ...
        <div class="d-flex flex-column align-items-end text-end">
          ...
          <div class="d-flex flex-nowrap align-items-center gap-2 pt-1">
            ...
            <div class="d-flex align-items-center gap-2 socials">
              <a href="https://www.facebook.com/groups/lcnlmahajan/" class="fs-4" aria-label="Facebook"><i
                  class="bi bi-facebook"></i></a>
              <a href="https://www.instagram.com/lcnlmahajan/" class="fs-4" aria-label="Instagram"><i
                  class="bi bi-instagram"></i></a>
              <a href="https://vimeo.com/lcnl" class="fs-4" aria-label="Vimeo"><i class="bi bi-vimeo"></i></a>
              <a href="https://www.youtube.com/@lcnlmahajan" class="fs-4 d-inline-flex align-items-center gap-1"
            ...
            <?php if (session()->get('isMemberLoggedIn')): ?>
              ...
              <a href="<?= base_url('membership/logout') ?>" class="btn btn-sm btn-link-brand">
                <i class="bi bi-box-arrow-right me-1"></i> Logout
              </a>
            <?php else: ?>
              <a href="<?= base_url('membership/login') ?>" class="btn btn-sm btn-brand rounded-pill">
